"""Verify every internal documentation link resolves. Run: python -m utils.check_docs

The repository has no test suite, and its documentation carries most of the
reasoning, so a rotted cross-reference is a real defect rather than cosmetic.
...
if __name__ == "__main__":
    files = markdown_files(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
