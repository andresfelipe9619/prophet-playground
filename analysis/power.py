...
The arithmetic mirrors `models/baseline.py:beats_chance_test` exactly, since the
...
from models.baseline import expected_main_matches, expected_super_match_rate
from models.common import DRAW_WEEKDAYS, MAIN_BALLS_DRAWN, MAIN_POOL, SUPER_POOL
